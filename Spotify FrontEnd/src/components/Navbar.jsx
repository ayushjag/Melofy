    ...
    <>
      ...
      <div className='w-full flex justify-between items-center font-semibold'>
        ...
        <div className='flex items-center gap-4'>
          ...
          <p onClick={() => navigate("/Contact")} className='bg-black py-1 px-3 rounded-2xl text-[15px] cursor-pointer hover:bg-gray-800'>Contact Me</p>
          <p onClick={() => navigate("/Signup")} className='bg-white text-black text-[15px] px-4 py-1 rounded-2xl hidden md:block cursor-pointer hover:bg-gray-200'>Sign Up</p>
